...
## 📌 Overview
**Branch:** `feature/pr-036-checkout-address-step` &rarr; `main`  
...
## 🎯 Description
feat(checkout): Address selection step with Indian cities & default pick. This pull request delivers enterprise-grade reliability, test coverage, and responsive UX across ShopSphere's multi-vendor ecosystem.

### Key Changes
- **Module:** `checkout-address-step`
