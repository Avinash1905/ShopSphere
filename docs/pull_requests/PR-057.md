# Pull Request #57: feat(seller): Store discount coupon creator with usage limits

## 📌 Overview
**Branch:** `feature/pr-057-seller-coupons-manager` &rarr; `main`  
...
## 🎯 Description
feat(seller): Store discount coupon creator with usage limits. This pull request delivers enterprise-grade reliability, test coverage, and responsive UX across ShopSphere's multi-vendor ecosystem.

### Key Changes
- **Module:** `seller-coupons-manager`
