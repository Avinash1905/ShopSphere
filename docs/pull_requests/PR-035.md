...
## 📌 Overview
**Branch:** `feature/pr-035-cart-shipping-estimator` &rarr; `main`  
...
## 🎯 Description
feat(cart): All-India pin code delivery estimator & SLA calculation. This pull request delivers enterprise-grade reliability, test coverage, and responsive UX across ShopSphere's multi-vendor ecosystem.

### Key Changes
- **Module:** `cart-shipping-estimator`
