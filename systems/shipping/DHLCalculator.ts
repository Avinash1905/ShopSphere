...
export class DHLShippingCalculator {
  ...
  public getRateQuotes(originZip: string, destZip: string, weightKg: number, itemValue: number): DHLRateQuote[] {
    ...
    return [
      {
        serviceCode: 'DHL_STD',
        serviceName: 'DHL Standard Ground',
        baseRate: baseCost,
        fuelSurcharge: fuel,
        residentialFee: 2.50,
      ...
      {
        serviceCode: 'DHL_EXP',
        serviceName: 'DHL Priority Express',
...
export const dhlCalculator = new DHLShippingCalculator();
