...
export class DPDShippingCalculator {
  ...
  public getRateQuotes(originZip: string, destZip: string, weightKg: number, itemValue: number): DPDRateQuote[] {
    ...
    return [
      {
        serviceCode: 'DPD_STD',
        serviceName: 'DPD Standard Ground',
        baseRate: baseCost,
        fuelSurcharge: fuel,
        residentialFee: 2.50,
      ...
      {
        serviceCode: 'DPD_EXP',
        serviceName: 'DPD Priority Express',
...
export const dpdCalculator = new DPDShippingCalculator();
