/**
 * ShopSphere Notifications Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface NotificationsQueryFilter {
...
export class NotificationsQueryBuilder {
  private filters: NotificationsQueryFilter = {};
  ...
  public build(): NotificationsQueryFilter {
    return { ...this.filters };
  }
}

export const createNotificationsQuery = () => new NotificationsQueryBuilder();
