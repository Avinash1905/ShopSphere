/**
 * ShopSphere Reports Query Builder & Filter Criteria
...
export class ReportsQueryBuilder {
  private filters: ReportsQueryFilter = {};
  ...
  public build(): ReportsQueryFilter {
    return { ...this.filters };
  }
}

export const createReportsQuery = () => new ReportsQueryBuilder();
