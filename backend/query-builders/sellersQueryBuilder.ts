/**
 * ShopSphere Sellers Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface SellersQueryFilter {
...
export class SellersQueryBuilder {
  private filters: SellersQueryFilter = {};
  ...
  public build(): SellersQueryFilter {
    return { ...this.filters };
  }
}

export const createSellersQuery = () => new SellersQueryBuilder();
