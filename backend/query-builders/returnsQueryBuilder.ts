/**
 * ShopSphere Returns Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface ReturnsQueryFilter {
...
export class ReturnsQueryBuilder {
  private filters: ReturnsQueryFilter = {};
  ...
  public build(): ReturnsQueryFilter {
    return { ...this.filters };
  }
}

export const createReturnsQuery = () => new ReturnsQueryBuilder();
