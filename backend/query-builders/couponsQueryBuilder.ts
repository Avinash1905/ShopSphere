/**
 * ShopSphere Coupons Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface CouponsQueryFilter {
...
export class CouponsQueryBuilder {
  private filters: CouponsQueryFilter = {};
  ...
  public build(): CouponsQueryFilter {
    return { ...this.filters };
  }
}

export const createCouponsQuery = () => new CouponsQueryBuilder();
