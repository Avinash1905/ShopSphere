/**
 * ShopSphere Audit Query Builder & Filter Criteria
...
export class AuditQueryBuilder {
  private filters: AuditQueryFilter = {};
  ...
  public build(): AuditQueryFilter {
    return { ...this.filters };
  }
}

export const createAuditQuery = () => new AuditQueryBuilder();
