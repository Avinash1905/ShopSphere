/**
 * ShopSphere Orders Query Builder & Filter Criteria
...
export class OrdersQueryBuilder {
  private filters: OrdersQueryFilter = {};
  ...
  public build(): OrdersQueryFilter {
    return { ...this.filters };
  }
}

export const createOrdersQuery = () => new OrdersQueryBuilder();
