/**
 * ShopSphere Payments Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface PaymentsQueryFilter {
...
export class PaymentsQueryBuilder {
  private filters: PaymentsQueryFilter = {};
  ...
  public build(): PaymentsQueryFilter {
    return { ...this.filters };
  }
}

export const createPaymentsQuery = () => new PaymentsQueryBuilder();
