/**
 * ShopSphere Refunds Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface RefundsQueryFilter {
...
export class RefundsQueryBuilder {
  private filters: RefundsQueryFilter = {};
  ...
  public build(): RefundsQueryFilter {
    return { ...this.filters };
  }
}

export const createRefundsQuery = () => new RefundsQueryBuilder();
