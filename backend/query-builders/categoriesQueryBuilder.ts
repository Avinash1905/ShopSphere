/**
 * ShopSphere Categories Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface CategoriesQueryFilter {
...
export class CategoriesQueryBuilder {
  private filters: CategoriesQueryFilter = {};
  ...
  public build(): CategoriesQueryFilter {
    return { ...this.filters };
  }
}

export const createCategoriesQuery = () => new CategoriesQueryBuilder();
