/**
 * ShopSphere Users Query Builder & Filter Criteria
...
export class UsersQueryBuilder {
  private filters: UsersQueryFilter = {};
  ...
  public build(): UsersQueryFilter {
    return { ...this.filters };
  }
}

export const createUsersQuery = () => new UsersQueryBuilder();
