/**
 * ShopSphere Products Query Builder & Filter Criteria
...
export class ProductsQueryBuilder {
  private filters: ProductsQueryFilter = {};
  ...
  public build(): ProductsQueryFilter {
    return { ...this.filters };
  }
}

export const createProductsQuery = () => new ProductsQueryBuilder();
