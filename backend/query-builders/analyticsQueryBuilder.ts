/**
 * ShopSphere Analytics Query Builder & Filter Criteria
...
export class AnalyticsQueryBuilder {
  private filters: AnalyticsQueryFilter = {};
  ...
  public build(): AnalyticsQueryFilter {
    return { ...this.filters };
  }
}

export const createAnalyticsQuery = () => new AnalyticsQueryBuilder();
