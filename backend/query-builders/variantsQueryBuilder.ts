/**
 * ShopSphere Variants Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface VariantsQueryFilter {
...
export class VariantsQueryBuilder {
  private filters: VariantsQueryFilter = {};
  ...
  public build(): VariantsQueryFilter {
    return { ...this.filters };
  }
}

export const createVariantsQuery = () => new VariantsQueryBuilder();
