/**
 * ShopSphere Brands Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface BrandsQueryFilter {
...
export class BrandsQueryBuilder {
  private filters: BrandsQueryFilter = {};
  ...
  public build(): BrandsQueryFilter {
    return { ...this.filters };
  }
}

export const createBrandsQuery = () => new BrandsQueryBuilder();
