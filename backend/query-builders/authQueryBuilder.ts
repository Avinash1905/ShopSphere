...
export class AuthQueryBuilder {
  private filters: AuthQueryFilter = {};
  ...
  public build(): AuthQueryFilter {
    return { ...this.filters };
  }
}

export const createAuthQuery = () => new AuthQueryBuilder();
