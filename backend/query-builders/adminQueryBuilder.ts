/**
 * ShopSphere Admin Query Builder & Filter Criteria
...
export class AdminQueryBuilder {
  private filters: AdminQueryFilter = {};
  ...
  public build(): AdminQueryFilter {
    return { ...this.filters };
  }
}

export const createAdminQuery = () => new AdminQueryBuilder();
