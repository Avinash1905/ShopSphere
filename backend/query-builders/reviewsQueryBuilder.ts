/**
 * ShopSphere Reviews Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface ReviewsQueryFilter {
...
export class ReviewsQueryBuilder {
  private filters: ReviewsQueryFilter = {};
  ...
  public build(): ReviewsQueryFilter {
    return { ...this.filters };
  }
}

export const createReviewsQuery = () => new ReviewsQueryBuilder();
