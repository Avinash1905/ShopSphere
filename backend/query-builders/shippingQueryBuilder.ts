/**
 * ShopSphere Shipping Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface ShippingQueryFilter {
...
export class ShippingQueryBuilder {
  private filters: ShippingQueryFilter = {};
  ...
  public build(): ShippingQueryFilter {
    return { ...this.filters };
  }
}

export const createShippingQuery = () => new ShippingQueryBuilder();
