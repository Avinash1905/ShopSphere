/**
 * ShopSphere Customers Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface CustomersQueryFilter {
...
export class CustomersQueryBuilder {
  private filters: CustomersQueryFilter = {};
  ...
  public build(): CustomersQueryFilter {
    return { ...this.filters };
  }
}

export const createCustomersQuery = () => new CustomersQueryBuilder();
