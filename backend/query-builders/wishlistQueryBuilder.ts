/**
 * ShopSphere Wishlist Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface WishlistQueryFilter {
...
export class WishlistQueryBuilder {
  private filters: WishlistQueryFilter = {};
  ...
  public build(): WishlistQueryFilter {
    return { ...this.filters };
  }
}

export const createWishlistQuery = () => new WishlistQueryBuilder();
