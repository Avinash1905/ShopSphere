...
export class CartQueryBuilder {
  private filters: CartQueryFilter = {};
  ...
  public build(): CartQueryFilter {
    return { ...this.filters };
  }
}

export const createCartQuery = () => new CartQueryBuilder();
