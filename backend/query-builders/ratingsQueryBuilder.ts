/**
 * ShopSphere Ratings Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface RatingsQueryFilter {
...
export class RatingsQueryBuilder {
  private filters: RatingsQueryFilter = {};
  ...
  public build(): RatingsQueryFilter {
    return { ...this.filters };
  }
}

export const createRatingsQuery = () => new RatingsQueryBuilder();
