/**
 * ShopSphere Search Query Builder & Filter Criteria
...
export class SearchQueryBuilder {
  private filters: SearchQueryFilter = {};
  ...
  public build(): SearchQueryFilter {
    return { ...this.filters };
  }
}

export const createSearchQuery = () => new SearchQueryBuilder();
