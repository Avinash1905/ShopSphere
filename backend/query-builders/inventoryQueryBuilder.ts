/**
 * ShopSphere Inventory Query Builder & Filter Criteria
...
export class InventoryQueryBuilder {
  private filters: InventoryQueryFilter = {};
  ...
  public build(): InventoryQueryFilter {
    return { ...this.filters };
  }
}

export const createInventoryQuery = () => new InventoryQueryBuilder();
