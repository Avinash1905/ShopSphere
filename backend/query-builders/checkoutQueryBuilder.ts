/**
 * ShopSphere Checkout Query Builder & Filter Criteria
 * Provides fluent SQL and memory query building with pagination, sorting, and joins.
 */

export interface CheckoutQueryFilter {
...
export class CheckoutQueryBuilder {
  private filters: CheckoutQueryFilter = {};
  ...
  public build(): CheckoutQueryFilter {
    return { ...this.filters };
  }
}

export const createCheckoutQuery = () => new CheckoutQueryBuilder();
