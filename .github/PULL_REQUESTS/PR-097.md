# Pull Request #97: test(unit): Unit tests for Indian GST tax calculations and currency

## 📌 Overview
**Branch:** `feature/pr-097-vitest-suite-pricing` &rarr; `main`  
...
## 🎯 Description
test(unit): Unit tests for Indian GST tax calculations and currency. This pull request delivers enterprise-grade reliability, test coverage, and responsive UX across ShopSphere's multi-vendor ecosystem.

### Key Changes
- **Module:** `vitest-suite-pricing`
